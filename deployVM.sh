...
az vm create --resource-group MinecraftGroup --name MinecraftAzure --image UbuntuLTS --admin-username azureuser --authentication-type ssh --generate-ssh-keys --public-ip-sku Standard --size Standard_D2ads_v5 --storage-sku Standard_LRS --os-disk-name MineOSHDD --os-disk-size-gb 30 --os-disk-caching ReadWrite --data-disk-sizes-gb 32 --data-disk-caching ReadWrite | tee results.txt
